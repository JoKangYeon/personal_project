...
<div id="parentMid">
    <div id="divLogo">
        <a class="logo" href="/market_board/boardList.com">
            <img src="/resources/images/logo.png" alt="로고" height="30px">
        </a>
    </div>
    <div id="mid">
        <h2>로그인</h2>
        <form action="/login/login.com" method="post">
            <div>
        ...
        <p style="margin-bottom: 0"><a href="/login/signup.com" style="text-decoration: none; font-size: 13px">SignUp</a></p>
